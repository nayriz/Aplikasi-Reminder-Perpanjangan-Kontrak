                ...
                <div class="row">
                    <div class="col-xl-12 col-md-12">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <form method="post" action="mod_penilaian/prosespenilaian.php?mod=penilaian&act=edit">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="hidden" class="form-control" name="id" id="hasil" value="<?=$data['idpenilaian']?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
