...
session_start();
include('koneksi.php');
$sql = mysqli_query($koneksi,"SELECT * from tbpenilaian inner join tbpegawai on tbpegawai.idpegawai=tbpenilaian.idpegawai where status!=''");
//error_reporting(0);
$no=1;
?>
                        ...
                        <div class="table-responsive">
                            <table id="data_table" class="table table-bordered table-striped" >
                                ...
                                <tr>
                                    ...
                                    <th>NIK</th>
                                    <th>Nama</th>
                                    <th><center>Nilai Hasil Kerja</center></th>
                                    <th><center>Nilai Perilaku Kerja</center></th>
                                    <th><center>Nilai Disiplin / Kehadiran</center></th>
                                    <th><center>Nilai Kerjasama</center></th>
                                    <th><center>Nilai Komitmen</center></th>
                                    <th>Total</th>
                                    <th>Keterangan</th>
<!--                                    <th>Action</th>-->
